            ...
            <form action="{{ route('courses.update', ['course' => $course->id]) }}" method="POST" role="form" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 pb-1">
                        ...
                        @if($course->image)
                            <img class="img-fluid" style="height: 100px;width: 200px" src="{{ asset('storage' . $course->image) }}" alt="">
                        @else
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="e1">Titulo do curso</label>
                                        <input type="text" name="title" value="{{ old('title') ? old('title') : $course->title }}" placeholder="Curso online...." id="e1" class="form-control @error('title') is-invalid @enderror">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="3" id="description" name="description" class="form-control @error('description') is-invalid @enderror">
                                           {{ old('description') ? old('description') : $course->description }}
                                        </textarea>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="3" id="objectives" name="objectives" class="form-control @error('objectives') is-invalid @enderror">
                                            {{ old('objectives') ? old('objectives') : $course->objectives }}
                                        </textarea>
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" value="{{ old('price') ? old('price') : $course->price }}" placeholder="Curso online...." id="e1" class="form-control @error('price') is-invalid @enderror">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total_videos" value="{{ old('total_videos') ? old('total_videos') : $course->total_videos }}" placeholder="17 vídeos" id="e1" class="form-control @error('total_videos') is-invalid @enderror">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="duration" value="{{ old('duration') ? old('duration') : $course->duration }}" placeholder="6 meses" id="e1" class="form-control @error('duration') is-invalid @enderror">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="channel_id" value="{{ old('channel_id') ? old('channel_id') : $course->channel_id }}" placeholder="60" id="e1" class="form-control @error('channel_id') is-invalid @enderror">
                            ...
                            <div class="row category-checkbox ml-2">
                                ...
                                @foreach($categories as $category)
                                    <div class="col-lg-2 col-sm-6 col-4 custom-control-inline custom-checkbox">
                                        <input type="checkbox" name="category_id" value="{{ $category->id }}" @if($category->id === $course->category_id) checked @endif class="custom-control-input" id="customCheck{{ $category->id }}">
